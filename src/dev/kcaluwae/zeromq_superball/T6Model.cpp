...
namespace
{
    ...
    const struct Config
    {
        double density;  //weight: 28g both endcaps  volume of both: 0.011 dm^3
        double radius;
        double density_mp;  //weight: 400g; volume
        double radius_mp;
    ...
    } /*c =
   {
     ...
     0.208,      //needs to be changed // density_mp (kg / length^3) weight of connecting rod:
  ...
  c =
     {
       ...
       258.36,   // stiffnessPassive (kg / sec^2)
       258.36,  // stiffnessActive (kg / sec^2)
       10.0,    // damping (kg / sec)
       10.33,     // rod_length (length)
       10.33/4,//4.5,      // rod_space (length)
       10.33/2,        // rod_length_mp (length)
